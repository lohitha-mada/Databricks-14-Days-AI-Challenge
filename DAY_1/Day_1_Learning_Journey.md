# Day 1 – Getting Started with Databricks 🚀
...
👉 This makes Databricks the preferred choice for modern, large-scale data workloads.
...
- **Workspace** → notebooks, folders, and projects
- **Compute** → clusters to run workloads
- **Data Explorer** → databases, tables, and files
...
✔ Explored the platform UI in detail  
✔ Navigated through Workspace, Compute, and Data Explorer  
✔ Created my **first Databricks notebook**  
✔ Ran basic **PySpark DataFrame operations**  
✔ Imported **CSV and JSON files**  
✔ Executed **SQL queries** on structured data  
...
![Created and executed my first notebook and ran basic PySpark commands.]([https://github.com/user-attachments/assets/eb531df8-0af3-44d5-b96d-23a5566cefc6](https://github.com/lohitha-mada/Databricks-14-Days-AI-Challenge/blob/main/DAY_1/PySpark_practice.png))
